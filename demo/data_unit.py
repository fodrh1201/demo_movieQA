...
class Dataset(object):
    ...
    def next_batch(self, batch_size, type = 'train'):
        ...
        if type == 'train':
            ...
            return self.zsl[start:end], self.zq[start:end], self.zaj[start:end], self.ground_truth[start:end]
            ...
            return self.zsl_val[start:end], self.zq_val[start:end], self.zaj_val[start:end], self.ground_truth_val[start:end]
